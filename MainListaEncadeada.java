...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("índice 0: " + (String)minhaListaEncadeada.get(0));
        System.out.println("índice 1: " + (String)minhaListaEncadeada.get(1));
        System.out.println("índice 2: " + (String)minhaListaEncadeada.get(2));
        System.out.println("índice 3: " + (String)minhaListaEncadeada.get(3));
        System.out.println("-------");
